*** Settings ***
Documentation   Valid Password and Empty Username
...
*** Test Cases ***
Valid Password and Empty Username
    [Documentation]
    ...  *****************
    ...  Basic information
    ...  *****************
    ...
    Input Valid Password and Empty Username  ${OPTIMYAPP_HOMEPAGE}    ${BROWSER}


*** Keywords ***
Input Valid Password and Empty Username
